...
const handler = async (m, { conn, usedPrefix, command, text }) => {
    ...
    if (command === 'banca') {
        ...
        const htmlBank = `<html><head><style>
            ...
            .atm-frame { width:950px; height:580px; background:linear-gradient(145deg, #annoyed, #111); border-radius:20px; display:flex; padding:30px; box-sizing:border-box; border:4px solid #444; }
